...
// 구버전 localStorage 데이터 정리 (유령 사용자 방지)
(function cleanLegacyData() {
  const LEGACY_KEYS = ['bookswap_local_table_users', 'bookswap_local_table_books',
                       'bookswap_local_table_exchange_requests', 'bookswap_local_table_book_access_permissions'];
  const VERSION_KEY = 'bookswap_data_version';
  const CURRENT_VERSION = '2'; // Firebase 전환 버전
